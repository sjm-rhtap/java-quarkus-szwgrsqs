...
export IMAGE_URL=${IMAGE_URL-quay.io/sjmrhtap/java-quarkus-szwgrsqs:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/sjm-rhtap/java-quarkus-szwgrsqs-gitops
